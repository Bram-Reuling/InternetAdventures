...
{
    public class NetworkPhysicsPlatformHandler : NetworkBehaviour
    {
        #region Variables
        ...
        {
            float platform1Mass = platform1.transform.GetChild(0).GetComponent<NetworkPhysicsPlatform>().GetTotalMass();
            float platform2Mass = platform2.transform.GetChild(0).GetComponent<NetworkPhysicsPlatform>().GetTotalMass();
            ...
            platform1.GetComponent<Rigidbody>()
                .DOMoveY(platformToActuate == _higherPlatform ? _platform1Actuated.y : _platform1InitPosition.y,
                    movementDuration);
            platform2.GetComponent<Rigidbody>()
                .DOMoveY(platformToActuate == _higherPlatform ? _platform2Actuated.y : _platform2InitPosition.y,
                    movementDuration);
        }
